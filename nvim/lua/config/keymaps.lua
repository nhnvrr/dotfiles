...
keymap.set("n", "<leader>du", "<cmd>DBUIToggle<CR>", { desc = "Toggle DB UI" })
keymap.set("n", "<leader>df", "<cmd>DBUIFindBuffer<CR>", { desc = "DB UI: find buffer" })
keymap.set("n", "<leader>da", "<cmd>DBUIAddConnection<CR>", { desc = "DB UI: add connection" })
keymap.set("x", "<leader>de", ":DB<CR>", { desc = "Execute SQL selection" })
keymap.set("n", "<leader>dE", "<cmd>%DB<CR>", { desc = "Execute entire SQL buffer" })
keymap.set("n", "<leader>dp", "vip:DB<CR>", { desc = "Execute current SQL paragraph" })
keymap.set("n", "<leader>dQ", "<cmd>DBCloseAll<CR>", { desc = "Close all DBUI buffers (full exit)" })

-- debug (nvim-dap)
keymap.set("n", "<F5>",  function() require("dap").continue() end,    { desc = "DAP: continue/start" })
...
keymap.set("n", "<leader>Db", function() require("dap").toggle_breakpoint() end, { desc = "DAP: toggle breakpoint" })
keymap.set("n", "<leader>DB", function() require("dap").set_breakpoint(vim.fn.input("Breakpoint condition: ")) end, { desc = "DAP: conditional breakpoint" })
keymap.set("n", "<leader>Du", function() require("dapui").toggle() end,          { desc = "DAP: toggle UI" })
keymap.set("n", "<leader>Dr", function() require("dap").repl.toggle() end,       { desc = "DAP: toggle REPL" })
keymap.set("n", "<leader>Dt", function() require("dap").terminate() end,         { desc = "DAP: terminate" })
