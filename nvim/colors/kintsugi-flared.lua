...
hl(0, "FloatTitle",      { fg = p.gold,      bg = p.bg_float })
hl(0, "LineNr",          { fg = p.line_nr,   bg = p.bg })
hl(0, "CursorLine",      { bg = p.bg_line })
hl(0, "CursorLineNr",    { fg = p.line_nr_active, bg = p.bg_line })
...
hl(0, "IncSearch",       { fg = p.bg, bg = p.gold })
hl(0, "CurSearch",       { fg = p.bg, bg = p.gold })
hl(0, "MatchParen",      { bg = p.bg_match })
hl(0, "Pmenu",           { fg = p.fg_dim, bg = p.bg_float })
hl(0, "PmenuSel",        { fg = p.fg,     bg = "#3e3b2c" })
...
hl(0, "QuickFixLine",    { bg = p.bg_line })
...
hl(0, "@keyword.function",       { fg = p.gold })
...
hl(0, "@keyword.storage",        { fg = p.gold })
...
-- Markdown / markup
hl(0, "@markup.heading",         { fg = p.gold })
hl(0, "@markup.heading.1",       { fg = p.gold })
hl(0, "@markup.heading.2",       { fg = p.gold })
hl(0, "@markup.heading.3",       { fg = p.gold_soft })
hl(0, "@markup.heading.4",       { fg = p.gold_soft })
hl(0, "@markup.strong",          { fg = p.gold })
...
hl(0, "@lsp.type.enum",          { fg = p.gold })
hl(0, "@lsp.type.enumMember",    { fg = p.amber })
hl(0, "@lsp.type.interface",     { fg = p.gold })
...
hl(0, "@lsp.type.struct",        { fg = p.gold })
hl(0, "@lsp.type.keyword",       { fg = p.red })
...
hl(0, "LspReferenceWrite",  { bg = "#2a313a" })
hl(0, "LspInlayHint",       { fg = p.gold_soft, bg = "#2a2a28", italic = true })
hl(0, "LspSignatureActiveParameter", { fg = p.gold })
...
hl(0, "FzfLuaTitle",         { fg = p.gold, bg = p.bg_dark })
hl(0, "FzfLuaPreviewTitle",  { fg = p.gold, bg = p.bg_dark })
...
hl(0, "DapUIScope",                     { fg = p.gold })
hl(0, "DapUIType",                      { fg = p.slate })
hl(0, "DapUIValue",                     { fg = p.amber })
hl(0, "DapUIModifiedValue",             { fg = p.orange })
...
hl(0, "DapUIBreakpointsCurrentLine",    { fg = p.gold })
