...
- Run `./install.sh` on macOS. The script will install Homebrew if missing, then install the casks for
Visual Studio Code, Spotify, and Google Chrome.
...
- The script only touches Homebrew and your home directory configs.
